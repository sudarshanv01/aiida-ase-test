# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-ase3
#
...
project = u'aiida-ase3'
copyright_first_year = '2020'
copyright_owners = 'Sudarshan Vijay'
...
release = aiida_ase3.__version__
...
html_use_opensearch = 'http://aiida-ase3.readthedocs.io'
...
htmlhelp_basename = 'aiida-ase3-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_ase3')

...
Check version number in setup.json and aiida_ase3/__init__.py and make sure
they match.
"""
# -*- coding: utf-8 -*-
...
import aiida_ase3  # pylint: disable=wrong-import-position

VERSION = aiida_ase3.__version__
